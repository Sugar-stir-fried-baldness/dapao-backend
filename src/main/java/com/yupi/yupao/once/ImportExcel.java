...
public class ImportExcel {
    ...
    public static void main(String[] args) {
        ...
        String fileName = "D:\\Microsoft Edge downlode\\testExcel.xlsx";
//          readByListener(fileName);
    ...
    public static void readByListener(String fileName) {
        ...
        EasyExcel.read(fileName, XingQiuTableUserInfo.class, new com.yupi.usercenter.easyExcel.TableListener()).sheet().doRead();
    }
